...
\section{Computation and study of the Schur with small flow approximation}
...
with
$$
\overline{LU} \boldsymbol{\xi}=\left(\boldsymbol{u}^n+\theta \boldsymbol{u}^n\cdot \nabla \boldsymbol{u}^n \right)\left(\theta \operatorname{div}(h^n \partial_t \boldsymbol{\xi})\right)
+\theta^2 \nabla\left[ \boldsymbol{\xi}\cdot \nabla p^n + 2p^n \operatorname{div}( \boldsymbol{\xi}) \right]
$$

\subsection{Wave study of the wave operator }
\subsubsection{Case $\boldsymbol{u}=\boldsymbol{0}$}
...
\subsubsection{Case $\boldsymbol{u}=\boldsymbol{cst}$}
...
\begin{equation*}
h^n\partial_{tt} \boldsymbol{\xi}+\theta h^n\left(\boldsymbol{u}^n\cdot\nabla\right) \partial_t\boldsymbol{\xi}- \left(\boldsymbol{u}^n+\theta \boldsymbol{u}^n\cdot \nabla \boldsymbol{u}^n \right)\left(\theta \operatorname{div}(h^n \partial_t \boldsymbol{\xi})\right)
+\theta^2 \nabla\left[ \boldsymbol{\xi}\cdot \nabla p^n + 2p^n \operatorname{div}( \boldsymbol{\xi}) \right]=0.
\end{equation*}
\end{document}