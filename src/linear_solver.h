...
typedef enum PC{NONE,JACOBI,PAR_JACOBI,PAR_ILU,PAR_MULTICOLOREDSGS,PAR_MULTICOLOREDGS,PAR_MULTICOLOREDILU,PAR_AMG_PC,PAR_ELIMI,PHY_BASED_P1,PHY_BASED_P2,PHY_BASED_U1,PHY_BASED_U2,EXACT} PC;
