...
typedef struct field {
  ...
  void (*update_after_rk)(void *fv, real *w);
  ...
  //! \param[in] ipg glop index
  //! \param[in] iv field component index
  int (*varindex)(int *deg, int *nraf, const int m, int elem, int ipg, int iv);
