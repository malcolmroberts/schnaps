...
void Periodic_Rusanov_BoundaryFlux(real *x, real t, real *wL, real *vnorm,
				       real *flux) {
  real wR[6];
...
void Periodic_HLL_BoundaryFlux(real *x, real t, real *wL, real *vnorm,
				       real *flux) {
  real wR[6];
  TestSH_periodic_ImposedData(x , t, wR);
  ShallowWater_HLL_NumFlux(wL, wR, vnorm, flux);
...
void Periodic_Roe_BoundaryFlux(real *x, real t, real *wL, real *vnorm,
				       real *flux) {
  real wR[6];
  TestSH_periodic_ImposedData(x , t, wR);
  ShallowWater_Roe_NumFlux(wL, wR, vnorm, flux);
